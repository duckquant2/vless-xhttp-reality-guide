# VPN своими руками: VLESS + XHTTP + Reality
...
VPS у российских провайдеров, чей ASN входит в белый список операторов (Yandex Cloud, VK Cloud). Подойдёт самый дешёвый сервер - туннель только пробрасывает трафик.
